const videoPlayer = document.querySelector<HTMLVideoElement>('.player') as HTMLVideoElement;
const snapAudio = document.querySelector('.snap') as HTMLAudioElement;
const stripEl = document.querySelector('.strip') as HTMLDivElement;
const canvasBoard = document.querySelector<HTMLCanvasElement>('.photo') as HTMLCanvasElement;
...
function paintToCanvas(video: HTMLVideoElement) {
